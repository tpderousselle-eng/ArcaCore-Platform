...
any generated files are written.
...
This increment does not implement named email, URL, phone, or slug formats,
custom callable validators, or validation inside generated API routes.
...
```powershell
python -m unittest tools.test_array tools.test_choice tools.test_one_to_one tools.test_many_to_many tools.test_composite_indexes tools.test_soft_delete tools.test_constraints tools.test_validators -v
```

The suite captures generated code in memory. It does not write backend files.
