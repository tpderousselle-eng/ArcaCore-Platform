...
CONTRACTS = (
    ...
    Contract("Production intelligence", ("-m", "unittest", "tools.test_structured_logging", "tools.test_observability", "tools.test_health_intelligence", "tools.test_resource_intelligence", "tools.test_extensions", "-v"), {}),
)
