...
class GamingStudioAuthorityTest(unittest.TestCase):
    ...
    def test_validator_has_no_generator_or_execution_dependencies(self):
        ...
        self.assertEqual(imports, {"argparse", "ast", "pathlib", "gaming_studio_intent", "gaming_studio_idea", "idea_intake", "gaming_studio_transition", "gaming_studio_plan", "gaming_studio_plan_checkpoint"})
